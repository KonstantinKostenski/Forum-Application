...
export interface ITodoItemsClient {
    getItemsWithPagination<ItemType>(url: string | undefined, listId: number | undefined, pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfItemsBriefDto<ItemType>>;
...
export class TodoItemsClient implements ITodoItemsClient {
    ...
    getItemsWithPagination<ItemType>(url: string, listId: number, pageNumber: number, pageSize: number): Observable<PaginatedListOfItemsBriefDto<ItemType>> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                  ...
                  return _observableThrow(e) as any as Observable<PaginatedListOfItemsBriefDto<ItemType>>;
                }
            } else
              return _observableThrow(response_) as any as Observable<PaginatedListOfItemsBriefDto<ItemType>>;
        }));
    }

    protected processGetItemsWithPagination<ItemType>(response: HttpResponseBase): Observable<PaginatedListOfItemsBriefDto<ItemType>> {
        ...
        if (status === 200) {
            ...
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
              result200 = resultData200.fromJS();
...
export class PaginatedListOfItemsBriefDto<ItemType> implements IPaginatedListOfItemBriefDto<ItemType> {
  items?: any[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
  ...
  constructor(data?: IPaginatedListOfItemBriefDto<ItemType>) {
        if (data) {
   ...
   fromJS(data: any): PaginatedListOfItemsBriefDto<ItemType> {
        data = typeof data === 'object' ? data : {};
    let result = new PaginatedListOfItemsBriefDto<ItemType>();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfItemBriefDto<ItemType> {
    items?: ItemType[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
